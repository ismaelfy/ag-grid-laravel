...
/* harmony import */ var _columns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./columns */ "./resources/js/columns.js");
...
var gridOptions = {
  columnDefs: _columns__WEBPACK_IMPORTED_MODULE_1__.Columns,
  rowData: null
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var datasource = {
    getRows: function getRows(params) {
      ...
      fetch("/api/users?startRow=".concat(startRow, "&endRow=").concat(endRow)).then(function (response) {
        if (!response.ok) {
